...
public enum  ProgramDateEnum {
    ...
    TUESDAY_MORNING("21","周二早间","7:20-08:00"),
    ...
    WEDNESDAY_MORNING("31","周三早间","7:20-08:00"),
    ...
    THURSDAY_MORNING("41","周四早间","7:20-08:00"),
    ...
    FRIDAY_MORNING("51","周五早间","7:20-08:00"),
    ...
    ProgramDateEnum(String code, String msg,String timeInterval) {
        this.code = code;
        this.msg = msg;
